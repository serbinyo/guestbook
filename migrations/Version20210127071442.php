 ...
 */
final class Version20210127071442 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE conference (id INT NOT NULL, city VARCHAR(255) NOT NULL, н�нyear VARCHAR(255) NOT NULL, is_international BOOLEAN NOT NULL, PRIMARY KEY(id))');
